...
namespace Avalonia
{
    internal class StrideRuntimePlatform : IRuntimePlatform
    {
        ...
        {
            private readonly StrideRuntimePlatform _plat;
            ...
            public UnmanagedBlob(StrideRuntimePlatform plat, int size)
            {
                if (size <= 0)
